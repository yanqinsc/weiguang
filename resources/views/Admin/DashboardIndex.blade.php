        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i>最新评论</a></li>
                        <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> 待审核</a></li>
                        <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i>回收站</a></li>
                    </ul>
                </li>
            </ul>
        </section>
